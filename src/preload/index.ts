...
const api: Api = {
  ...
  dictate: (wav, language) => ipcRenderer.invoke('dictate', wav, language),
  micAccess: () => ipcRenderer.invoke('mic:access'),
  meetingStart: (wsId, title, opts) => ipcRenderer.invoke('meeting:start', wsId, title, opts),
  ...
  meetingSummarize: (id) => ipcRenderer.invoke('meeting:summarize', id),
  meetingSummary: (id) => ipcRenderer.invoke('meeting:summary', id),
  meetingToKb: (id) => ipcRenderer.invoke('meeting:kb', id),
  meetingRename: (id, title) => ipcRenderer.invoke('meeting:rename', id, title),
